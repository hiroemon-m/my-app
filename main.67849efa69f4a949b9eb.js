  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (update && searchList.length > 0 && topic) {
      ...
      const promises = Array.from({
        ...
        const parameterPath = `${"/my-app"}/data/visualize_data/topic${target_id + 1}/persona/test_optimize_${p}.txt`;
